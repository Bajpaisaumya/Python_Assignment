'''Scenario: You have a list of coordinate pairs representing suspected treasure
 locations on a map: coords = [[12, 5], [-3, 14], [8, -2], [15, 9], [-5, -6]].
...
def treasure_map():
    coords=[[12, 5], [-3, 14], [8, -2], [15, 9], [-5, -6],[2,4],[0.07,2.7]]
    for i in coords:
        if i[0]>0 and i[1]>0:
            print(i)
treasure_map()
